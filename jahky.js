...
///////////////////////////////////////////////////////////////////////////////////////////
  ...
  client.on("ready", () => {
        client.channels.cache.get('1062007240539779153').join();
        });
      
      client1.on("ready", () => {
        client1.channels.cache.get('1062007240539779153').join();
        });
      
      client2.on("ready", () => {
        client2.channels.cache.get('1062007240539779153').join();
        });
      
      client3.on("ready", () => {
        client3.channels.cache.get('1062007240539779153').join();
        });
      
      client4.on("ready", () => {
        client4.channels.cache.get('1062007240539779153').join();
        });
